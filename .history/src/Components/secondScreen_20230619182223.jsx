        ...
        <div className="Right_Comp">
          <div className="Trading_News">
            ...
            <div className="Full_Image">
              <img src="https://i2-prod.mirror.co.uk/incoming/article30150001.ece/ALTERNATES/s1200/0_MAIN-TLB-main.jpg" alt="" />
          ...
          <div className="Trading_News">
            ...
            <div className="Full_Image">
              <img src="https://sportstiger-images.s3.ap-south-1.amazonaws.com/media/messi-inter-miami-sportstiger-1-1686307265629-original.jpg" alt="" />
              <p className="date">12 May 2023</p>
              <p className="desc">
                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                diam nonumy eirmod tempo
