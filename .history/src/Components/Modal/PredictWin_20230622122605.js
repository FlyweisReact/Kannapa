...
export function PredictWin(props, question) {
  return (
    <Modal
      {...props}
    ...
    >
      <Modal.Body className="Predict_Win_Modal">
        <i
          className="fa-regular fa-circle-xmark Close_Button"
          onClick={() => props.onHide()}
        ></i>

        <div className="Predict_Win Modal_Pridcy">
          <div className="Right_Comp">
            {question ? (
              ...
              <div className="Content">
                ...
                <button onClick={() => props.setQuestion(true)}>
                  Start Predicting
                </button>
              </div>
            )}
