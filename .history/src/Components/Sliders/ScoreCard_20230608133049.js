    ...
    <div style={{ overflowX: "hidden" }}>
      <Slider {...settings} className="ScoreCard_Slider">
        <div className="Main_Item">
          ...
          <p className="Scorecard" onClick={() => navigate('/scoreCard')} >Scorecard</p>
        </div>
        ...
        <div className="Main_Item">
          ...
          <p className="Scorecard" style={{cursor : 'pointer'}} onClick={() => navigate('/scoreCard')} >Scorecard</p>
        </div>
...
remaining overs
        ...
        <div className="Main_Item">
          ...
          <p className="desc">
          Stumps : Day 1 Pakistan Shaheens trail by 48 runs.          </p>
