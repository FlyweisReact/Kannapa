      ...
      return (
       <div className="Slider_Container_Div">
         <Slider {...settings} className="Video_Slider">
          <div className={`Main_Item ${themeClass}`} onClick={() => navigate('/News')}>
            <img src="/Images/5.png" alt="" />
            <p className="Video_Slider_Dark_P">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam </p>
          </div>
