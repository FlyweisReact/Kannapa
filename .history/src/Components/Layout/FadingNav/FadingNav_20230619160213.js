...
const FadingNav = () => {
  ...
  return (
   ...
   {/* <button className="Toggle" onClick={() => ThemeSetter()}>
              <img src="./Images/25.png" alt="" />
              <img src="./Images/24.png" alt="" />
            </button> */}
          {theme === "light" ? (
         
            <img src="./Images/131.png" alt=""  onClick={() => ThemeSetter()} style={{cursor : 'pointer'}}/>
  

          ) : (
            <img src="./Images/130.png" alt=""  onClick={() => ThemeSetter()} style={{cursor : 'pointer'}}/>
