      ...
      <div className="Index_Three_Sec_Layout Sport_Index_Three_Sec_Layout News_Two_Sec_layout ">
        <div className="Mid_Comp">
            <div className="Min_Item">
              <img src='https://talksport.com/wp-content/uploads/sites/5/2023/06/JF-HERO-TALKSPORT-TRANSFERS-BLOG.jpg?strip=all&quality=100&w=1360&h=579&crop=1' alt='' />

              <p className="desc">Chennai Super Kings (CSK)</p>
              <p className="head">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore.</p>
              <p className="content">
              CSK vs KKR, IPL 2023: Chennai Super Kings all-rounder Ravindra Jadeja replied in an
amazing and completely forthright way when asked if he…
              </p>
              <div>
                <p>By <span>Nishant Singh</span></p>
                <p>May 11, 2023</p>
              </div>
            </div>
