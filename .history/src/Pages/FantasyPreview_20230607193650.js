      ...
      <div className="Fantasy_Two_Sec">
        ...
        <div className="Right_Comp">
          ...
          <div className="Item">
            ...
            <p className="date"> France national team 

Read More: https://www.sportstiger.com/news/didier-deschamps-announces-france-squad-for-junes-euro-2024-qualifiers
...
Koo: https://www.kooapp.com/profile/sportstiger </p>
            <p className="head">
