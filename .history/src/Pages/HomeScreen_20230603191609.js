...
import MyVerticallyCenteredModal from '../Components/ModalMyVerticallyCenteredModal'
        ...
        <div className="Index_Three_Sec_Layout Index_Three_Sec_Layout_2 ">
          ...
          <div className="Mid_Comp">
            ...
            <div className="Pagination_Div">
              <p tabIndex={0}><i className="fa-solid fa-angle-left"></i></p>
              <p tabIndex={0} >1</p>
              <p tabIndex={0}>2</p>
              <p tabIndex={0}>3</p>
              <p tabIndex={0}>4</p>
              ...
              <p tabIndex={0}>...</p>
              <p tabIndex={0}>238</p>
              <p tabIndex={0}><i className="fa-solid fa-angle-right"></i></p>
            </div>
          </div>
