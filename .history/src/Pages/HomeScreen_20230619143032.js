...
import {handledarkMode} from '../Components/Store/actions/darkModaAction'
  ...
  return (
    <>
      ...
      <section className="HomePage">
        ...
        <div className="Mobile_Tab_Slider_Blog" style={{margin : 0}}>
          <BlogSlider />
        </div>
        ...
        <div className={`Index_Three_Sec_Layout Index_Three_Sec_Layout_2 ${themeClass}`}>
          <div className={`left_Comp ${themeClass}`}>
            <div className={`Trading_News ${themeClass}`}>
        ...
        <div className={`Index_Three_Sec_Layout Index_Three_Sec_Layout_2 ${themeClass}`}>
          ...
          <div className={`Mid_Comp ${themeClass}`}>
            ...
            <div className={`Blog_Div ${themeClass}`} style={{ marginTop: "20px" }}>
              <p>IPL 2023</p>
