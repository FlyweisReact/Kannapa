      ...
      <div className={themeClass}>
        <div className="Live_Score_Two_Sec ScoreCard_Two_Sec_Layout ">
          <div className="Left_Comp">
           ...
           <div className={themeCl}>
           <div className="Content_Div">
              <p className="head">Fall of Wickets</p>
              <div>
                <p>
                  130-1 (Kirk McKenzie, 39.6 ov) , 160-2 (Raymon Reifer, 51.6
                  ov) , 281-3 (Tagenarine Chanderpaul, 82.2 ov) , 281-4 (Brandon
                  King, 82.6 ov) , 283-5 (Alick Athanaze , 83.6 ov) , 317-6
                  (Yannic Cariah, 99.5 ov)
                </p>
              </div>
            </div>
           </div>
