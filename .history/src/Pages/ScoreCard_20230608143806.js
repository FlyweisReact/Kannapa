            ...
            <div className="fourth7">
              <table className="fourth8">
                ...
                <div className="Content_Div">
                    <p>Fall of Wickets</p>
                    <div>
                        <p>130-1 (Kirk McKenzie, 39.6 ov) , 160-2 (Raymon Reifer, 51.6 ov) , 281-3 (Tagenarine Chanderpaul, 82.2 ov) , 281-4 (Brandon King,
82.6 ov) , 283-5 (Alick Athanaze , 83.6 ov) , 317-6 (Yannic Cariah, 99.5 ov)</p>
                    </div>
                </div>
