...
const LiveScore = () => {
  ...
  return (
    <>
      ...
      <div className="MaxWidth_Div">
        <div className={`Live_Score_Three_Buttons ${themeClass}`}>
      ...
      <div className="Live_Score_Two_Sec MaxWidth_Div">
        ...
        <div className="Right_Comp ">
          <div className={`third8 ${themeClass} Hide_For_Mobile_Special`}>
      ...
      <div className="Live_Score_Two_Sec MaxWidth_Div">
        <div className="Left_Comp Hide_For_Mobile_Special">
          <div className={`third5 ${themeClass}`}>
            <p className="Third5_Dark_p">International League T20 2023</p>
            <button>VIEW ALL</button>
          </div>
        ...
        <div className="Right_Comp ">
          ...
          <div className={`third13 ${themeClass} Hide_For_Mobile_Special`}>
            <div className="third14">
              <button>FEATURED VIDEOS</button>
            </div>
