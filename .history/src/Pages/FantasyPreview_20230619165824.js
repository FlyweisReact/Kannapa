...
const FantasyPreview = () => {
  ...
  return (
    <>
      ...
      <div className={`Fantasy_Three_Sec ${themeClass}`}>
        <div className="Item">
          <p>Format</p>
          <select className="Fantasy_Dark_Select">
      ...
      <div className={`Fantasy_Two_Sec ${themeClass}`}>
        ...
        <div className="Right_Comp">
          <div className="Item">
            <img
              src="https://sportstiger-images.s3.ap-south-1.amazonaws.com/media/sportstiger-1-1686145837835-original.jpg"
              alt=""
            />
          ...
          <div className="Item">
            <img
              src="https://sportstiger-images.s3.ap-south-1.amazonaws.com/media/sportstiger-1685542876756-original.jpg"
              alt=""
            />
            <p className="date"> France national team </p>
            <p className="head">
              Didier Deschamps announces France squad for June’s Euro 2024
              qualifiers
            </p>
            <div className="two">
              <p>
      ...
      <div className={`Fantasy_Five_Sec ${themeClass}`}>
        {data.map((i, index) => (
